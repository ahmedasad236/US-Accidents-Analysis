...
def linear_regression(data, learning_rate, num_iterations, num_features):
  """
  ...
  for i in range(num_iterations):
    ...
    gradient_rdd = data.map(lambda point: calculate_gradient(point, weights, num_features))

    # Reduce step: Aggregate gradients to get overall update
    total_gradient = gradient_rdd.reduce(lambda g1, g2: np.add(g1, g2))
  ...
  def calculate_gradient(point, weights, num_features):
    """
